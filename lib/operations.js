...
ops.DisposeQualificationType = {
  schema: {},
  validateResponse: function(response) {
    return response.DisposeQualificationTypeResult.Request.IsValid.toLowerCase() === 'true';
  }
};
...
ops.GetFileUploadURL = {
  schema: {},
  validateResponse: function(response) {
    return response.GetFileUploadURLResult.Request.IsValid.toLowerCase() === 'true';
  }
};
...
ops.GetQualificationRequests = {
  schema: {},
  validateResponse: function(response) {
    return response.GetQualificationRequestsResult.Request.IsValid.toLowerCase() === 'true';
  }
};
...
ops.GetQualificationScore = {
  schema: {},
  validateResponse: function(response) {
    return response.GetQualificationScoreResult.Request.IsValid.toLowerCase() === 'true';
  }
};
...
ops.GetQualificationType = {
  schema: {},
  validateResponse: function(response) {
    return response.GetQualificationTypeResult.Request.IsValid.toLowerCase() === 'true';
  }
};
...
ops.GetRequesterStatistic = {
  schema: {},
  validateResponse: function(response) {
    return response.GetRequesterStatisticResult.Request.IsValid.toLowerCase() === 'true';
  }
};
...
ops.GetRequesterWorkerStatistic = {
  schema: {},
  validateResponse: function(response) {
    return response.GetRequesterWorkerStatisticResult.Request.IsValid.toLowerCase() === 'true';
  }
};
...
ops.GetReviewResultsForHIT = {
  schema: {},
  validateResponse: function(response) {
    return response.GetReviewResultsForHITResult.Request.IsValid.toLowerCase() === 'true';
  }
};
...
ops.GrantQualification = {
  schema: {},
  validateResponse: function(response) {
    return response.GrantQualificationResult.Request.IsValid.toLowerCase() === 'true';
  }
};
...
ops.Help = {
  schema: {},
  validateResponse: function(response) {
    return response.HelpResult.Request.IsValid.toLowerCase() === 'true';
  }
};
...
ops.NotifyWorkers = {
  schema: {},
  validateResponse: function(response) {
    return response.NotifyWorkersResult.Request.IsValid.toLowerCase() === 'true';
  }
};
...
ops.RegisterHITType = {
  schema: {},
  validateResponse: function(response) {
    return response.RegisterHITTypeResult.Request.IsValid.toLowerCase() === 'true';
  }
};
...
ops.RejectQualificationRequest = {
  schema: {},
  validateResponse: function(response) {
    return response.RejectQualificationRequestResult.Request.IsValid.toLowerCase() === 'true';
  }
};
...
ops.RevokeQualification = {
  schema: {},
  validateResponse: function(response) {
    return response.RevokeQualificationResult.Request.IsValid.toLowerCase() === 'true';
  }
};
...
ops.SearchHITs = {
  ...
  validateResponse: function(response) {
    return response.SearchHITsResult.Request.IsValid.toLowerCase() === 'true';
  }
};
...
ops.SearchQualificationTypes = {
  schema: {},
  validateResponse: function(response) {
    return response.SearchQualificationTypesResult.Request.IsValid.toLowerCase() === 'true';
  }
};
...
ops.SendTestEventNotification = {
  schema: {},
  validateResponse: function(response) {
    return response.SendTestEventNotificationResult.Request.IsValid.toLowerCase() === 'true';
  }
};
...
ops.SetHITAsReviewing = {
  schema: {},
  validateResponse: function(response) {
    return response.SetHITAsReviewingResult.Request.IsValid.toLowerCase() === 'true';
  }
};
...
ops.SetHITTypeNotification = {
  schema: {},
  validateResponse: function(response) {
    return response.SetHITTypeNotificationResult.Request.IsValid.toLowerCase() === 'true';
  }
};
...
ops.UnblockWorker = {
  schema: {},
  validateResponse: function(response) {
    return response.UnblockWorkerResult.Request.IsValid.toLowerCase() === 'true';
  }
};
...
ops.UpdateQualificationScore = {
  schema: {},
  validateResponse: function(response) {
    return response.UpdateQualificationScoreResult.Request.IsValid.toLowerCase() === 'true';
  }
};
...
ops.UpdateQualificationType = {
  schema: {},
  validateResponse: function(response) {
    return response.UpdateQualificationTypeResult.Request.IsValid.toLowerCase() === 'true';
  }
};
